...
- Business Justification (1-10)
- Offline Validation Possible (1-10)
- Risk of Hurting Model (1-10, lower is better)

Priority Score =
(Expected Gain + Business + Offline + (10-Risk)) / Difficulty

---

| ID | Experiment | Gain | Diff | Business | Offline | Risk | Priority |
|----|------------|------|------|----------|---------|------|----------|
| EXP001 | Weight Optimization | 9 | 5 | 9 | 9 | 3 | ⭐⭐⭐⭐⭐ |
| EXP002 | Multi-Factor Revenue Rate | 8 | 6 | 10 | 8 | 5 | ⭐⭐⭐⭐ |
| EXP003 | Interaction Features v2 | 7 | 3 | 8 | 8 | 3 | ⭐⭐⭐⭐⭐ |
